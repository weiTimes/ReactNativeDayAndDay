 ...
 * @Last Modified time: 2017-05-26 10:24:58
 * 
 * 我的阅读 图书列表中的每一个item
 */
            ...
            <TouchableOpacity style={[styles.row, styles.item]} {...this.props}>
                ...
                <View style={styles.con}>
                    ...
                    <View style={styles.margin10}>
                        <Text style={styles.title} numberOfLines={1}>{ROW.book.publisher}</Text>
                    </View>
                    <View style={styles.margin10}>
                        <Text style={styles.title} numberOfLines={1}>{ROW.book.author}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        );
